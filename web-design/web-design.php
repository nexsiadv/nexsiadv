    ...
    <div class="tab_container">
        ...
        <div class="tab_content">
            ...
            <div class="dx">
                ...
                <h3>Nexsiadv &egrave; in grado di portarvi al successo nel web attraverso una rigorosa applicazione degli standard  e  tecnologie allo stato dell'arte.</h3>
                <p>La realizzazione di un sito web &egrave; <strong>un'operazione che coinvolge e fonde   diverse competenze</strong>. In Nexsiadv sappiamo come bene come deve essere svolto questo compito: Il prodotto finale deve essere gradevole, di facile   esplorazione, deve presentare in maniera chiara i propri contenuti ed essere   utilizzabile in sicurezza, fluidit&agrave; e massima semplicit&agrave;.</p>
                ...
                <p>Concetti come <strong>accessibilit&agrave;</strong>, <strong>usabilit&agrave;</strong>, <strong>conformit&agrave;</strong> a standard tecnici ben definiti e non ultimi concetti tipici del marketing come <strong>brand-awareness</strong> (percezione dell'immagine aziendale) e <strong>customer care</strong>, sono altrettanto importanti per raggiungere gli obiettivi sopra delineati ed in <strong>Nexsiadv sappiamo come renderli al massimo</strong>.</p>
