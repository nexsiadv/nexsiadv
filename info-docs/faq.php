...
<div id="content" class="clearfix">
    <div class="sx">
        <div class="box standard">
            ...
            <ul class="menu">
                <li><a href="#" class="active" title="Servizi e consulente per il web marketing e la comunicazione integrata">Web marketing mix</a></li>
                <li><a href="#" title="#">Domanda 1</a></li>
                <li><a href="#" title="search engine optimization">Domanda 2</a></li>
            </ul>
            <div class="clearer ten"></div>
            <h3>Domande di carattere tecnico</h3>
            <ul class="menu">
                <li><a href="#" title="#">Domanda 1<em></em></a></li>
                <li><a href="#" title="#">Domanda 2</a></li>
            </ul>
        </div>
    </div>
    <div class="dx">
        ...
        <p>Hai appena avviato il tuo nuovo business online? Adesso hai bisogno della  nostre competenze in WEB MARKETING e ADVERTISING per poter cogliere a pieno il  successo che desideri. Per incrementare il numero delle vendite si deve apportare traffico e nuovi  utenti, ma tuttavia cosa accade se questo traffico &egrave; troppo, oppure se non conduce ad una vendita o  ad una richiesta di offerta (tasso di conversione) ? A che che serve un sito web con un altissimo <u><a href="#">tasso di conversione</a></u> senza un proporzionato traffico di utenti?</p>
        <div class="clearer ten"></div>
